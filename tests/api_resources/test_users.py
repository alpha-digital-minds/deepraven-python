...
class TestUsers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_create_with_list(self, client: Deepraven) -> None:
        user = client.users.create_with_list()
        assert_matches_type(User, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_create_with_list_with_all_params(self, client: Deepraven) -> None:
        user = client.users.create_with_list(
            items=[
                {
                    "id": 10,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_create_with_list(self, client: Deepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_create_with_list(self, client: Deepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_login_with_all_params(self, client: Deepraven) -> None:
        user = client.users.login(
            password="password",
            username="username",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_logout(self, client: Deepraven) -> None:
        user = client.users.logout()
        assert user is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_logout(self, client: Deepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_logout(self, client: Deepraven) -> None:
...
class TestAsyncUsers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_create_with_list(self, async_client: AsyncDeepraven) -> None:
        user = await async_client.users.create_with_list()
        assert_matches_type(User, user, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_create_with_list_with_all_params(self, async_client: AsyncDeepraven) -> None:
        user = await async_client.users.create_with_list(
            items=[
                {
                    "id": 10,
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_create_with_list(self, async_client: AsyncDeepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create_with_list(self, async_client: AsyncDeepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_login_with_all_params(self, async_client: AsyncDeepraven) -> None:
        user = await async_client.users.login(
            password="password",
            username="username",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_logout(self, async_client: AsyncDeepraven) -> None:
        user = await async_client.users.logout()
        assert user is None

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_logout(self, async_client: AsyncDeepraven) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_logout(self, async_client: AsyncDeepraven) -> None:
